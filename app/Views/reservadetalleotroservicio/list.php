									...
									<?php if(!empty($datos)):?>
										<?php foreach($datos as $reservadetalleotroservicio):?>
											<tr>
												...
												<td ><?php echo $reservadetalleotroservicio['idreserva'];?></td>
												...
												<td ><?php echo $reservadetalleotroservicio['idotroservicio'];?></td>
