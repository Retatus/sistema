		...
		<div class='modal-body'>
			<div class='form-group row'>
				<div class='col-6 form-group row'hidden>
					...
					<div class = 'col-sm-8'>
						<input type='text' class='form-control form-control-sm text-uppercase    123' id='idcathotel' name='idcathotel' placeholder='T001' autocomplete = 'off'>
					</div>
				</div>
...
<script>
	...
	$('#idbanco').autocomplete({ 
		source: function(request, response) {
			$.ajax({
				type: 'POST',
				url: base_url + '/hotel/autocompletebancos',
				dataType: 'json',
