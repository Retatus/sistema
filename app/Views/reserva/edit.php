			...
			<div class='col-12'>
				<div class='card'>
					...
					<div class='card-body'>
						<div class='form-group row'>								
									...
									<div class='col-sm-8'>											
										<div class="input-group">
											<div class="input-group-prepend">
												...
												<?php if(!empty($reserva)){ ?>
													<input type='text' class='form-control form-control-sm' id='fechainicio' name='fechainicio' value="<?php echo $reserva['fechainicio']."-".$reserva['fechafin'];?>" readonly>
												<?php } ?>
										</div>
									</div>
								</div>									
							...
							<div class='col-4'>
								<div class='form-group row'>
									...
									<div class = 'col-sm-12'>
										<button type='button' class='btn btn-info btn-block btn-sm' id='btnAgregarCliente' value="<?php echo $reserva['reservanombre'];?>">PASAJERO</button>
									</div>
								</div>
							</div>
							<div class='col-4' hidden>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<input type='text' class='form-control form-control-sm text-uppercase' id='tipodoc' value="<?php echo $reserva['tipodoc'];?>" placeholder='T001' autocomplete = 'off'>
									</div>
								</div>
							</div>
							<div class='col-4' hidden>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<input type='text' class='form-control form-control-sm text-uppercase' id='idpersona' value="<?php echo $reserva['idpersona'];?>" placeholder='T001' autocomplete = 'off'>
									</div>
								</div>
							</div>								
							<div class='col-4' hidden>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<input type='text' class='form-control form-control-sm text-uppercase' id='reservatelefono' value="<?php echo $reserva['reservatelefono'];?>" placeholder='T001' autocomplete = 'off'>
									</div>
								</div>
							</div>								
							<div class='col-4'hidden>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<input type='text' class='form-control form-control-sm text-uppercase' id='reservacorreo' value="<?php echo $reserva['reservacorreo'];?>" value='no-send@tato.pe' autocomplete = 'off'>
									</div>
								</div>
							</div>						
						</div>
								...
								<tbody>
									<?php if(!empty($clientes)):?>
										<?php foreach($clientes as $cliente):?>
											<tr>												
												<td ><?php echo $cliente['idtipodoc3'];?></td>
												<td hidden><?php echo $cliente['idtipodoc3'];?></td>
												<td ><?php echo $cliente['idcliente2'];?></td>
												<td ><?php echo $cliente['clientenombre2'];?></td>
												<td ><?php echo $cliente['clienteapellidos2'];?></td>
												<td ><?php echo $cliente['clientetelefono2'];?></td>
												<td hidden><?php echo $cliente['clientecorreo2'];?></td>
												<td hidden><?php echo $cliente['clientedireccion2'];?></td>
												<td class = 'hidden-xs'><?php echo $cliente['clientepais2'];?></td>
												<td class = 'hidden-xs'><?php echo $cliente['clientefechanacimiento2'];?></td>
												<td ><?php echo $cliente['clienteedad2'];?></td>
												<td >
													<?php $sexos  = array(array('valor' => "1",'texto' => "M"), array('valor' => "0",'texto' => "F"));?>
													<select class="form-control form-control-sm" id="estado" name="estado">
													<?php foreach($sexos as $sexo):?>
														<?php if ($cliente['clientesexo2'] == $sexo['valor']) { ?>
															<option value= "<?php echo $sexo['valor'];?>" selected><?php echo $sexo['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $sexo['valor'];?>"><?php echo $sexo['texto'];?></option>
														<?php } ?>
													<?php endforeach;?>
													</select>
												</td>
												<td >
													<?php $estados  = array(array('valor' => "1",'texto' => "ACTIVO"), array('valor' => "0",'texto' => "DESACTIVO"));?>
													<select class="form-control form-control-sm" id="estado" name="estado">
													<?php foreach($estados as $estado):?>
														<?php if ($cliente['clienteestado2'] == $sexo['valor']) { ?>
															<option value= "<?php echo $estado['valor'];?>" selected><?php echo $estado['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $estado['valor'];?>"><?php echo $estado['texto'];?></option>
														<?php } ?>														
													<?php endforeach;?>
													</select>
												</td>
												<td >
													<div class="row">
														<div style="margin: auto;">
															<a class='btn btn-danger btn-xs' href='<?php echo base_url();?>/reserva/add'><i class='fa fa-times'></i></a>
														</div>
														<div style="margin: auto;">
															<a class='btn btn-info btn-xs' href='javascript:void(0)' onclick="btnEditarCliente('<?php echo $cliente['idcliente'].'\',\''. $cliente['idtipodoc'];?>')"><i class='fa fa-pencil'></i></a>
														</div>
														<div style="margin: auto;">
						...
						<div class='demo-content scroll' style='margin-right: 0px; margin-left: 0px;'>
							<table class='table table-sm table-bordered table-striped' id ='tablaDetalleServicio'>
								...
								<tbody>
									<?php if(!empty($servicios)): $i = 0?>									
										<?php print_r($servicios); foreach($servicios as $cliente):  $i++;?>
											<tr id=Fila_<?php echo $i;?>>
												<td hidden><?php echo $i;?></td>
												<td hidden><input type='text' class='form-control form-control-sm' id='detalleTipoServicio_<?php echo $i;?>' value='<?php echo $cliente['idcategoria0'];?>'></td>
												<td hidden><input type='text' class='form-control form-control-sm' id='detalleIdReserva_<?php echo $i;?>' value='<?php echo $cliente['nidreserva'];?>'></td>											
												<td>
													<?php $afectacion  = array(array('valor' => "10",'texto' => "GRAV"), array('valor' => "20",'texto' => "EXON"),array('valor' => "30",'texto' => "INAF"), array('valor' => "40",'texto' => "EXPO"));?>
													<select class="form-control form-control-sm" id="detalleGravado_<?php echo $i;?>">
													<?php foreach($afectacion as $igv):?>
														<?php if ($cliente['estado2'] == $igv['valor']) { ?>
															<option value= "<?php echo $igv['valor'];?>" selected><?php echo $igv['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $igv['valor'];?>"><?php echo $igv['texto'];?></option>
														<?php } ?>
													<?php endforeach;?>
													</select>
												</td>
												<td ><?php echo $cliente['categoria0'];?></td>
												<td ><?php echo $cliente['idservicio0'];?></td>
												<td ><?php echo $cliente['concatenado0'];?></td>
												<td><input type='text' class='form-control form-control-sm text-uppercase datepicker<?php echo $i?>' onkeyup = 'addDatepicker(<?php echo $i?>)' id='detalleFecha_<?php echo $i?>' value = '<?php echo $cliente['fecha0'];?>' readonly></td>
												<td><input type='text' class='form-control form-control-sm text-uppercase numeroDerecha' id='detallecantidad_<?php echo $i?>' onkeyup='ImporteTotalDetalle(<?php echo $i?>)' value = '<?php echo $cliente['cantidad0'];?>'></td>
												<td><input type='text' class='form-control form-control-sm text-uppercase numeroDerecha' id='detalleprecio_<?php echo $i?>' onkeyup='ImporteTotalDetalle(<?php echo $i?>)' value = '<?php echo $cliente['precio0'];?>'></td>
												<td><input type='text' class='form-control form-control-sm text-uppercase numeroDerecha' id='detalletotal_<?php echo $i?>' value = '<?php echo $cliente['total0'];?>' readonly></td>												
												<td >
													<?php $confirmado  = array(array('valor' => "1",'texto' => "CONFIRMADO"), array('valor' => "0",'texto' => "PENDIENTE"));?>
													<select class="form-control form-control-sm" id='detalleConfirmado_<?php echo $i?>' name="estado">
													<?php foreach($confirmado as $estado):?>
														<?php if ($cliente['confirmado0'] == $estado['valor']) { ?>
															<option value= "<?php echo $estado['valor'];?>" selected><?php echo $estado['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $estado['valor'];?>"><?php echo $estado['texto'];?></option>
														<?php } ?>														
												...
												<td >
													<?php $sexos  = array(array('valor' => "1",'texto' => "PAGADO"), array('valor' => "0",'texto' => "PENDIENTE"));?>
													<select class="form-control form-control-sm" id='detallePagado_<?php echo $i?>' name="estado">
													<?php foreach($sexos as $sexo):?>
														<?php if ($cliente['estado2'] == $sexo['valor']) { ?>
															<option value= "<?php echo $sexo['valor'];?>" selected><?php echo $sexo['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $sexo['valor'];?>"><?php echo $sexo['texto'];?></option>
														<?php } ?>
												...
												<td >
													<?php $estados  = array(array('valor' => "1",'texto' => "ACTIVO"), array('valor' => "0",'texto' => "DESACTIVO"));?>
													<select class="form-control form-control-sm" id='detalleEstado_<?php echo $i?>' name="estado">
													<?php foreach($estados as $estado):?>
														<?php if ($cliente['clienteestado'] == $estado['valor']) { ?>
															<option value= "<?php echo $estado['valor'];?>" selected><?php echo $estado['texto'];?></option>
														<?php } else { ?>
															<option value= "<?php echo $estado['valor'];?>"><?php echo $estado['texto'];?></option>
														<?php } ?>														
												...
												<td >
													<div class="row">
														<div style="margin: auto;">
															<a class='btn btn-danger btn-xs' href='javascript:void(0)' onClick="EliminarFila('<?php echo $i;?>')"><i class='fa fa-times'></i></a>
														</div>
														<div style="margin: auto;">
															<a class='btn btn-info btn-xs' href='javascript:void(0)' onclick="btnEditarCliente('<?php echo $cliente['idcliente'].'\',\''. $cliente['idtipodoc'];?>')"><i class='fa fa-pencil'></i></a>
														</div>
						...
						<div class='form-group row'>
							...
							<div class='col-4'>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<?php if(!empty($reserva)){ ?>
											<input type='text' class='form-control form-control-sm' style="text-align: right;" id='pagado' name='pagado' value="<?php echo $reserva['montototal'];?>" readonly>
										<?php } else { ?>
											<input type='text' class='form-control form-control-sm' style="text-align: right;" id='pagado' name='pagado' placeholder='T001' autocomplete = 'off'>
										<?php } ?>
							...
							<div class='col-4'>
								<div class='form-group row'>
									...
									<div class = 'col-sm-8'>
										<?php if(!empty($reserva)){ ?>
											<input type='text' class='form-control form-control-sm' style="text-align: right;" id='montototal' name='montototal' value="<?php echo $reserva['montototal'];?>" readonly>
										<?php } else { ?>
											<input type='text' class='form-control form-control-sm' style="text-align: right;" id='montototal' name='montototal' placeholder='T001' autocomplete = 'off'>
										<?php } ?>
									</div>
								</div>
							</div>						
					...
					<div class='card-footer'>
						<button type='button' class='btn btn-warning btn-sm' id='btnModalAgregarReserva' style="padding: .25rem 5.5rem;">Modificar</button>
...
<script>
	...
	$('#idticketbus').autocomplete({ 
		...
		select: function( event, ui ) {
			...
			var rows = "<tr id=Fila_" + (i + 1) + ">"+
				...
				"<td><input type='text' class='form-control form-control-sm text-uppercase numeroDerecha' id='detallecantidad_" + (i + 1) + "' onkeyup='ImporteTotalDetalle(" + (i + 1) + ")' value='1'></td>"+
				"<td><input type='text' class='form-control form-control-sm text-uppercase numeroDerecha' id='detalleprecio_" + (i + 1) + "' onkeyup='ImporteTotalDetalle(" + (i + 1) + ")' value='" + ui.item.precio + "'></td>"+
	...
	$('#btnModalAgregarReserva').click(function(){
		if (ValidarCamposVaciosReserva() != 0) {
			...
			EnviarInformacionReserva('editar', NuevoReserva, true);
		}
	});
	...
	function EnviarInformacionReserva(accion, objEvento, modal, pag=1) { 
		...
		$.ajax({
			type: 'POST',
			url: base_url+'/reserva/reservaedit',
			data: Reserva,
			success: function(msg){
