...
//   SECCION ====== INDEX ======
	...
	{
		$clientetipo = $this->clientetipo->getClientetipos(20, 1, 1, '');
...
//   SECCION ====== OPCIONES ======
	public function opciones(){
		...
		$respt = ['id' => $id, 'mensaje' => $mensaje, 'pag' => $this->paginado->pagina($pag, $total, $adjacents), 'datos' => $this->clientetipo->getClientetipos(20, $pag, $todos, $texto)];
...
//   SECCION ====== Clientetipo SELECT NOMBRE ======
...
//   SECCION ====== EXCEL ======
	public function excel()
	{
		...
		$clientetipo = $this->clientetipo->getClientetipos($total, 1, 1, '');
		...
		$sheet->setCellValue('A1', 'IDCLIENTETIPO');
		...
		foreach ($clientetipo as $row){
			$sheet->setCellValue('A'.$i, $row['idclientetipo']);
